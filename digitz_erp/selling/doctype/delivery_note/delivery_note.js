				...
				frappe.call(
					{
						...
						args: {
							...
							'fieldname': ['default_warehouse', 'rate_includes_tax','allow_edit_delivery_note_no']
						},
						callback: (r2) => {
							...
							frm.custom.allow_delivery_note_no = r2.message.allow_edit_delivery_note_no;
							
							frm.set_df_property("delivery_note_no", "hidden", !frm.custom.allow_delivery_note_no);
