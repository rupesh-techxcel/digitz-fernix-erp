...
frappe.ui.form.on('Depreciation Entry', {
    refresh: function(frm) {
      ...
      setup: function(frm) {
        frm.set_query('account', 'depreciation_entry_details', function() {
            return {
                filters: [
                    ["is_group", "=", 0],
                    ["account_type", "in", ["Accumulated Depreciation", "Depreciation"]]
                ]
            };
        });
    },
  ...
  frappe.ui.form.on('Depreciation Entry Detail', {
    ...
    depreciation_entry_details_add: function(frm, cdt, cdn) {
    ...
    depreciation_entry_details_remove: function(frm, cdt, cdn) {
      calculate_totals(frm);
    }
